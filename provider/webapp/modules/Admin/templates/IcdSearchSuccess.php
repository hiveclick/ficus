...
<div class="content-header">
	<h1>Manage All ICD-10 Codes
		<small>ICD-10 Codes are used when assigning treatment plans to patients during intake.  This list is updated from the main system.</small>
	</h1>
	<ol class="breadcrumb">
		...
		<div class="box-header with-border">
			...
			<div class="box-tools">
				<form id="icd_search_form" method="GET" action="/api">
					...
					<input type="hidden" id="show_approved_only" name="show_approved_only" value="0" />
