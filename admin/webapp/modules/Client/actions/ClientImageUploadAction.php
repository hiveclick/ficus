...
// +----------------------------------------------------------------------------+
class ClientImageUploadAction extends BasicRestAction
{
	...
	public function execute ()
	{
	    ...
	    try {
		    ...
		    if (\MongoId::isValid($input_form->getId())) {
    	        ...
    	        throw new \Exception('Cannot find a client to match the id');
    	    }
