	   ...
	   <div class="nav-tabs">
            ...
            <div class="tab-content">
                <div class="active tab-pane fade in" id="basic">
            		...
            		<div class="form-group">
            			<label class="control-label hidden-xs" for="name">Provider</label>
            			<select name="provider" id="provider">
                            <?php
                                /* @var $provider \Ficus\Provider */ 
                                foreach ($providers as $provider) {
                            ?>
                                <option value="<?php echo $provider->getId() ?>" <?php echo $staff->getProvider()->getId() == $provider->getId() ? 'selected' : '' ?>><?php echo $provider->getName() ?></option>
                            <?php } ?>
            			</select>
            		</div>
            		
            		<div class="form-group">
            			<label class="control-label hidden-xs" for="staff_type">Type</label>
            		...
            		<div class="form-group">
                        <div class="row">
                            <div class="col-md-8"><label class="control-label hidden-xs" for="status_1">Staff Status</label></div>
