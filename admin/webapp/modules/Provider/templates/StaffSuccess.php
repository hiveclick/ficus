        ...
        <div class="col-md-3">
            ...
            <div class="box box-primary">
                <div class="box-body box-profile">
                    <a href="/provider/care-giver-image-wizard?_id=<?php echo $staff->getId() ?>" data-toggle="modal" data-target="#edit_staff_img_modal"><img class="profile-user-img img-responsive img-circle" src="<?php echo $staff->getProfileImageUrl() != '' ? $staff->getProfileImageUrl() : '/img/default-profile.png' ?>" id="staff_profile_image" alt="User profile picture"></a>
...
<!-- edit care giver image modal -->
<div class="modal fade" id="edit_staff_img_modal"><div class="modal-dialog modal-lg"><div class="modal-content"></div></div></div>
