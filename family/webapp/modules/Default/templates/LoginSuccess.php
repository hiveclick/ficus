        ...
        <div class="container-fluid">
            ...
            <form name="login_form" method="POST" action="/login">
        		...
        		<div class="form-group">
        			<div class="form-label hidden-xs" for="name">Enter your <b>e-mail address</b></div>
        			<div class="">
    ...
    <div class="fs_split_pane fs_split_pane_right">
        <div class="container-fluid">
            ...
            <div class="fs_split_body" style="padding:240px 25px;">
                <img src="/images/login-step.png" />
                <h1>Use Ficus for better medical record keeping</h1>
                <div class="help-block">Using Ficus, you can easily manage your rehab centers whether you have one home or several facilities across the nation.</div>
            </div>
